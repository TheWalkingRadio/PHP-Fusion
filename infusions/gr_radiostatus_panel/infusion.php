...
rs_transip			VARCHAR(255) NOT NULL DEFAULT '0.0.0.0',
rs_port				VARCHAR(5) NOT NULL DEFAULT '8000',
rs_transport			VARCHAR(5) NOT NULL DEFAULT '7999',
rs_pw				VARCHAR(255) NOT NULL DEFAULT '',
rs_apw				VARCHAR(255) NOT NULL DEFAULT '',
rs_transpw			VARCHAR(255) NOT NULL DEFAULT '',
...
rs_gbintervall		SMALLINT(5) UNSIGNED NOT NULL DEFAULT '3',
...
rs_streamcenter		TINYINT(1) UNSIGNED NOT NULL DEFAULT '1',
